...
function AddPlacePopup(props) {
    ...
    return (
        <PopupWithForm name='add-card' title='Новое место' onClose={props.onClose} submit='Создать' isOpen={props.isOpen} onSubmit={handleSubmit} >
            ...
            <input type="url" className="popup__text popup__text_type_place-url" id="url-input" name="link" placeholder="Ссылка на картинку" value={link} onChange={handleChangeLink} required />
